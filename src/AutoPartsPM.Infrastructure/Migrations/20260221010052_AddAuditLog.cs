        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectManagerId = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewerId = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GateReviews_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssigneeId = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ...
                    RelatedPhase = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubmissionLevel = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PPAPDocuments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PPAPDocuments_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GateReviews_ProjectId_GateNumber",
                table: "GateReviews",
                columns: new[] { "ProjectId", "GateNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PPAPDocuments_ProjectId_ElementNumber",
                table: "PPAPDocuments",
                columns: new[] { "ProjectId", "ElementNumber" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectPhases_ProjectId_Phase",
                table: "ProjectPhases",
